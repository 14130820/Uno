...
Shader "Shadero Customs/CardShader"
{
Properties
{
...
_OperationBlend_Fade_4("_OperationBlend_Fade_4", Range(0, 1)) = 0
...
float4 OperationBlend_4 = OperationBlend(OperationBlend_2, NewTex_1, _OperationBlend_Fade_4); 
float4 TintRGBA_1 = TintRGBA(NewTex_1, float4(0.9150943,0.8937656,0.2115077,1));
float4 OperationBlend_3 = OperationBlend(TintRGBA_1, OperationBlend_4, _OperationBlend_Fade_3); 
